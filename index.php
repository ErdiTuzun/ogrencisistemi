...
<head>
    ...
    <title>Fakülte Yönetim Sistemi - Giriş Yap</title>
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Öğrenci Bilgi Sistemi</h1>
                                </div>
                                <form class="user">
                                    <div class="form-group">
                                        <input type="name" class="form-control form-control-user"
                                               placeholder="Kullanıcı Adı / Demo123...">
                                    </div>
                                    <div class="form-group">
                                        <input type="sifre" class="form-control form-control-user"
                                               id="exampleInputPassword" placeholder="Şifreniz / Demo123">
                                    </div>
                                    <div class="form-group">
...
<!--                                                Me</label>-->
                                ...
                                <div class="text-center">
                                    <a class="small" href="#">Üyelik Oluştur!</a>
                                </div>
                            </div>
                        </div>
                    </div>
